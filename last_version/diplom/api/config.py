...
LOCAL_LLM_MODEL_NAME = os.getenv("LOCAL_LLM_MODEL_NAME", "qwen2.5:3b")
...
INDEX_MANIFEST_PATH = Path(os.getenv("INDEX_MANIFEST_PATH", str(DHB_DIR / "indexed_files.json")))
...
LOCAL_LLM_RETRY_TIMES_SEC = _retry_schedule("LOCAL_LLM_RETRY_TIMES_SEC", (2.0, 5.0, 10.0))
